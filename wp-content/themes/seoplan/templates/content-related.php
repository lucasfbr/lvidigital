...
$post_class = 'col-xs-4 blog-item';
if ( $layout && ( 'left-sidebar' == $layout || 'right-sidebar' == $layout ) )
{
	$post_class = 'col-xs-6 blog-item';
}
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( $post_class ); ?>>
	...
	<div class="post-info">
		<span class="author">
			...
			?>
			<a class="author-name" href="<?php get_author_posts_url( $user_id ); ?>" title="<?php echo esc_attr( sprintf( __( 'View all posts of %s', 'seoplan' ), $name ) ); ?>" rel="author">
